...
function SkeletonCard() {
    return (
        <HexPanel fill="var(--fp-surface-primary)" cut={14} contentStyle={{ padding: '22px 20px' }}>
...
export default function DiscoverPage() {
    ...
    const majorFromUrl = searchParams.get('major') as FilterMajor | null

    const isValidMajor = MAJOR_FILTERS.some((m) => m.id === majorFromUrl)
    ...
    const [majorFilter, setMajorFilter] = useState<FilterMajor>(
        majorFromUrl && isValidMajor ? majorFromUrl : 'all'
    )
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="max-w-6xl mx-auto w-full px-6 pb-8">
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div style={{ width: 1, height: 20, background: 'rgba(111,149,197,0.25)', margin: '0 4px' }} />
            ...
            <main className="max-w-6xl mx-auto w-full px-6 pb-24 flex-1">
                {loading ? (
                    ...
                    <div className="flex justify-center py-24">
                        <HexPanel fill="rgba(220,38,38,0.08)" borderColor="rgba(220,38,38,0.35)" cut={14} contentStyle={{ padding: '36px 48px', textAlign: 'center' }}>
                            ...
                            <button onClick={() => load(1, true)}>Try again</button>
                        </HexPanel>
                    </div>
                ) : visibleProjects.length === 0 ? (
                    <div className="flex justify-center py-24">
                        <HexPanel fill="var(--fp-surface-primary)" cut={14} contentStyle={{ padding: '40px 56px', textAlign: 'center' }}>
